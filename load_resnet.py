...
model = SimpleResNet()
model.load_weights('model/cifar10_model')
...
valid_loader = valid_dataset.map(preprocess).batch(batch_size) #repeat할 필요가 있나? 
...
val_loss_mean = numpy.array(val_loss_list)
val_loss_mean = val_loss_mean.mean()

print("test_loss: ", val_loss_mean)
# print(f"Epoch [{epoch}] Val Loss: {mean(val_loss_dict[epoch]):.4f}")
print("========================================================================================")
